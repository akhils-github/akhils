...
export const ChatInterface = ({
    ...
    return (
        <>
            ...
            <section className="flex flex-col justify-between w-full h-full mx-auto border px-2 border-zinc-700 bg-zinc-900 text-zinc-50">
                <article className="flex flex-col overflow-y-auto flex-1 flex-grow w-full">
                    {history.length === 1 && (
                        <aside className="px-6 py-20 md:px-12 md:py-24">
                            <h1 className="text-2xl text-center leading-tight border border-md border-zinc-800 p-4">
                                Hi <span className="font-bold text-emerald-300">I'm Lonz</span>, your AI Assistant ✨
                            </h1>
                        </aside>
                    )}
